...
async function inspect() {
    try {
        ...
        fs.writeFileSync('c:/Users/chand/Downloads/RMFrontend/inspect_result.json', JSON.stringify(results, null, 2));
        process.exit(0);
    } catch (err) {
        fs.writeFileSync('c:/Users/chand/Downloads/RMFrontend/inspect_error.txt', err.stack);
        process.exit(1);
    }
}
inspect();
